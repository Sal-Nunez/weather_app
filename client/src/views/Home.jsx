...
const Home = (props) => {
    ...
    useEffect(() => {
        if (!weatherInfo) {
            if (user) {
                ...
                navigator.geolocation.getCurrentPosition(location, user)
                function location(location, user) {
                    if (user === null) {
    ...
    return (
        <>
            ...
            <div style={{ maxWidth: '992px', margin: 'auto' }} className="d-flex my-5 inside-modal">
                <div className="mb-3">
