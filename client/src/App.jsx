...
const App = () => {
    ...
    return (
        ...
        <Home setUser={setUser} user={user} weatherInfo={weatherInfo} setWeatherInfo={setWeatherInfo} api_key={api_key} unit={unit} setUnit={setUnit} search={searchHandler} cityHandler={cityHandler}/>
        </Switch>
        </>
    )
}
